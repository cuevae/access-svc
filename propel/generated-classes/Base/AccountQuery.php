 ...
 *
 * @method     \ClientQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class AccountQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'abcbank', $modelName = '\\Account', $modelAlias = null)
    {
